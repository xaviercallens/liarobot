"""
Programme principal - Robot avec YEUX BLEUS et sourire style Cozmo
Pour apprendre la programmation avec votre enfant !

Version avec yeux bleus brillants ! 💙
"""
...
def main():
    """Programme principal avec yeux bleus"""
    # Initialiser Pygame
    pygame.init()
    ...
    pygame.display.set_caption("🤖 Robot Sourire BLEU - Style Cozmo 💙")
    ...
    # 💙 PERSONNALISER LES COULEURS EN BLEU 💙
    robo.bg_color = (0, 10, 30)  # Fond bleu très foncé
    robo.fg_color = (80, 200, 255)  # Yeux bleu cyan brillant
    
    # Configuration initiale
    print("🤖 Initialisation du robot BLEU...")
    print("💙 Les yeux sont maintenant BLEUS !")
    print("📝 Instructions:")
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_ESCAPE:
                    ...
                    # Ouvrir les yeux
                    print("👀 Ouverture des yeux BLEUS")
                    robo.open_eyes()
        ...
        # Afficher le texte d'aide en bleu
        font = pygame.font.Font(None, 24)
        help_text = "💙 ROBOT BLEU 💙 | ESPACE: Sourire | O: Ouvrir | C: Fermer | B: Cligner | ESC: Quitter"
        text_surface = font.render(help_text, True, (100, 200, 255))  # Texte bleu
